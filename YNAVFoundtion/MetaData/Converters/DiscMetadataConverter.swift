...
class DiscMetadataConverter: NSObject,ConverterProtocol {
    func displayValueFromMetadataItem(_ item: AVMetadataItem) -> AnyObject {
        ...
        let dict = ["discNumber":number,"discCount":count]
    ...
    func metadataItemFromDisplayValue(_ value: AnyObject, metadataItem item: AVMetadataItem) -> AVMetadataItem {
        ...
        let trackNumber: Int = trackData["discNumber"] as! Int
        let trackCount: Int = trackData["discCount"] as! Int
